...
export default function EnglishPage() {
    const lang = igcseLanguages.english;
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg max-w-3xl mx-auto">
                            Our platform is specifically designed for Cambridge IGCSE English as a Second Language students.
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-center text-gray-600 mb-8">Complete exam breakdown for Core tier</p>
                    </motion.div>
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="bg-coral-100 p-3 rounded-lg border-2 border-black">
                                        {index === 0 ? <BookOpen size={24} className="text-coral-600" /> : <Headphones size={24} className="text-coral-600" />}
                                    </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-center text-gray-600 mb-8">Complete exam breakdown for Extended tier</p>
                    </motion.div>
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="bg-primary-100 p-3 rounded-lg border-2 border-black">
                                        {index === 0 ? <BookOpen size={24} className="text-primary-600" /> : <Headphones size={24} className="text-primary-600" />}
                                    </div>
                                    <div className="flex-1">
                                        <h3 className="text-xl font-bold mb-2">{paper.number}</h3>
                                        <h4 className="text-lg font-semibold text-primary-600 mb-3">{paper.title}</h4>
            ...
            {/* Oral Endorsement */}
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-coral-50">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-3 text-center">
                            {lang.examStructure.oral.name}
                        </h2>
                    </motion.div>

                    {lang.examStructure.oral.papers.map((paper, index) => (
                        <motion.div
                            key={index}
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="bg-coral-100 p-3 rounded-lg border-2 border-black">
                                    <Mic size={24} className="text-coral-600" />
                                </div>
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold mb-2">{paper.number}</h3>
                                    <h4 className="text-lg font-semibold text-coral-600 mb-3">{paper.title}</h4>
                                    <p className="text-gray-600 mb-4">{paper.description}</p>
                                    <div className="grid grid-cols-3 gap-3 text-sm">
                                        <div className="bg-gray-100 p-2 rounded border border-gray-300">
                                            <p className="font-semibold text-gray-500">Duration</p>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h2 className="text-4xl sm:text-5xl font-bold mb-6">
                            Ready to Master{' '}
                            <span className="font-handwritten text-coral-400">IGCSE English?</span>
                        </h2>
