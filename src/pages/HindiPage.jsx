...
export default function HindiPage() {
    const lang = igcseLanguages.hindi;
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg max-w-3xl mx-auto">
                            Our platform is specifically designed for Cambridge IGCSE Hindi as a Second Language students.
                            Every exercise, practice session, and feedback is aligned with the official IGCSE syllabus and exam format,
                            with full support for Devanagari script.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h2 className="text-4xl sm:text-5xl font-bold mb-6">
                            Ready to Master{' '}
                            <span className="font-handwritten text-coral-400">IGCSE Hindi?</span>
                        </h2>
